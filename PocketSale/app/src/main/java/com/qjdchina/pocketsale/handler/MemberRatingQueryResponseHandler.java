 ...
 */
public class MemberRatingQueryResponseHandler extends AbstractResponseHandler {

    private static final String TAG = "MemberRatingQueryResponseHandler";

    private Handler handler;

    public MemberRatingQueryResponseHandler(Handler handler) {
        this.handler = handler;
    }

    @Override
    protected int getSupportMessageType() {
        return MessageType.QUERY_RATING.getType();
    }
